...
export const en = {
    ...
    results: {
        ...
        json: {
            ...
            emptyDescription: "There is nothing to render as JSON. Adjust the query and re-run.",
            countLabel_one: "{{count}} document",
            countLabel_few: "{{count}} documents",
            countLabel_many: "{{count}} documents",
            countLabel_other: "{{count}} documents",
            copyButton: "Copy JSON",
            copiedBadge: "Copied",
            copyAriaLabel: "Copy result as JSON",
            copySuccessTitle: "Copied to clipboard",
            copySuccessDescription_one: "{{count}} document as JSON",
            copySuccessDescription_few: "{{count}} documents as JSON",
            copySuccessDescription_many: "{{count}} documents as JSON",
            copySuccessDescription_other: "{{count}} documents as JSON",
            copyErrorTitle: "Could not copy JSON",
        },
    },
    saveQuery: {
        title: "Save Query",
    ...
    aggregationBuilder: {
        ...
        editor: {
            title: "Stage Editor",
            countLabel: "Count",
            countPlaceholder: "Enter number",
            outputFieldLabel: "Output Field Name",
            outputFieldPlaceholder: "count",
            jsonLabel: "Stage Configuration (JSON)",
        ...
        library: {
            ...
            stagesCount_few: "{{count}} stages",
            stagesCount_many: "{{count}} stages",
            stagesCount_other: "{{count}} stages",
            addStageAria: "Add {{label}} stage — {{description}}",
            descriptions: {
                ...
                addFields: "Compute new fields per doc",
    ...
    geospatial: {
        ...
        title: "Geospatial Query Builder",
        labels: {
            ...
            polygon: "Polygon Coordinates (JSON)",
            additionalFilter: "Additional Filter (JSON)",
        },
        placeholders: {
            field: "location",
            minDistance: "Optional",
        },
        polygonHelp: "Format: [[lng1, lat1], [lng2, lat2], ...]",
        useMyLocation: "Use my location",
        useMyLocationAria: "Use device location for coordinates",
        execute: "Execute Query",
        executing: "Executing…",
        toasts: {
            geolocationUnavailableTitle: "Geolocation not available",
            geolocationUnavailableDescription: "Your browser does not support the geolocation API.",
            locationSet: "Location set",
            locationFailedTitle: "Could not get your location",
        },
        errors: {
            invalidCoordinates: "Longitude and latitude must be valid numbers",
            outOfRangeCoordinates: "Coordinates out of range (longitude ±180, latitude ±90)",
            invalidPolygon: "Invalid polygon coordinates JSON",
            invalidFilter: "Invalid additional filter JSON",
